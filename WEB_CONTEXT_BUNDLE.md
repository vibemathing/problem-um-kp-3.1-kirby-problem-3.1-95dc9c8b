...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.1-kirby-problem-3.1-95dc9c8b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.1"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.1-kirby-problem-3.1-95dc9c8b-v1",
      "problem_contract_sha256": "99dbc6e6f934799af0dab656aad84b850a06ebefc253a722e3c1a2649e892c96",
      "problem_id": "problem:um-kp-3.1-kirby-problem-3.1-95dc9c8b",
      "route_id": "route:um-kp-3.1-kirby-problem-3.1-95dc9c8b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.1-kirby-problem-3.1-95dc9c8b-source-fidelity-01",
      "graph_id": "graph:um-kp-3.1-kirby-problem-3.1-95dc9c8b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.1-kirby-problem-3.1-95dc9c8b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.1-kirby-problem-3.1-95dc9c8b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Classify the smallest volume hyperbolic 3-manifolds of various types. In particular: (a) Determine the nonorientable closed hyperbolic 3-manifolds of least volume. (b) Determine the n-cusped hyperbolic 3-manifolds of least volume for each $n\\geq 3$. (c) Determine the smallest volume hyperbolic 3-manifolds with n orientable cusps for each n. (d) Determine the n-cusped orientable hyperbolic 3-manifolds of least volume for each n."
          },
          "statement_sha256": "5d1cf35660d716c9055d2eb6128a96580cca92489a05535d748227a8ea0ede60"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.1-kirby-problem-3.1-95dc9c8b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.1-kirby-problem-3.1-95dc9c8b-root",
      "route_id": "route:um-kp-3.1-kirby-problem-3.1-95dc9c8b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.1-f936730286a1",
        "url": "https://www.unsolvedmath.com/problems/KP-3.1"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
